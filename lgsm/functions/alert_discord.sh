...
{
	"username":"LinuxGSM",
	"avatar_url":"https://gitee.com/${githubuser}/${githubrepo}/raw/${githubbranch}/lgsm/data/alert_discord_logo.png",
	"file":"content",
	"embeds": [{
		"color": "2067276",
		"author": {"name": "${alertemoji} ${alertsubject}", "icon_url": "https://gitee.com/${githubuser}/${githubrepo}/raw/${githubbranch}/lgsm/data/alert_discord_logo.png"},
		"title": "",
