...
fn_install_server_files(){
	if [ "${gamename}" == "Battlefield: 1942" ]; then
		...
		fileurl="https://s3.amazonaws.com/linuxgsm/hlds_l3016_beta_cstrike_nowon.tar.gz"; filedir="${tmpdir}"; filename="hlds_l3016_beta_cstrike_nowon.tar.gz";  executecmd="noexecute" run="norun"; force="noforce"; md5="357fd6178f6df2f0c28ea36b81b0f40e"
