...
fn_fetch_default_config(){
	...
	echo -e "================================="
	echo -e "default configs from https://github.com/GameServerManagers/Game-Server-Configs\n本脚本默认不再从github上获取config文件，config地址：https://gitee.com/DefiedParty/Game-Server-Configs"
	fn_sleep_time
	mkdir -p "${lgsmdir}/config-default/config-game"
	githuburl="https://gitee.com/DefiedParty/Game-Server-Configs/raw/master"
